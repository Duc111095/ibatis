...
import com.ducnh.ibatis.io.SerialFilterChecker;
...
public abstract class AbstractSerialStateHolder implements Externalizable {
	...
	protected final Object readResolve() throws ObjectStreamException {
		if (this.userBean != null && this.useBeanBytes.length == 0) {
			return this.userBean;
		}
		
		SerialFilterChecker.check();
		
		try (ObjectInputStream in = new ObjectInputStream(new ByteArrayInputStream(this.useBeanBytes))) {
