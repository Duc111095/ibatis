...
public class XMLStatementBuilder extends BaseBuilder{
	...
	public void parseStatementMode() {
		...
		if (resultSetTypeEnum == null) {
			resultSetTypeEnum = configuration.getDefaultResutlSetType();
		}
		...
		builderAssistant.addMappedStatement(id, sqlSource, statemenType, slqCommandType, fetchSize, timeout, parameterMap,
	...
	private void parseSelectKeyNode(String id, XNode nodeToHandle, Class<?> parameterTypeClass, LanguageDriver langDriver,
		...
		ResultSetType  resutSetTypeEnum = null;
		
		SqlSource sqlSource = langDriver.createSqlSource(configuration, nodeToHandle, parameterTypeClass);
		SqlCommandType sqlCommandType = SqlCommandType.SELECT;
	
		builderAssistant.addMappedStatement(id, sqlSource, statementType, sqlCommandType, fetchSize, timeout, parameterMap,
			parameterTypeClass, resultMap, resultTypeClass, resutSetTypeEnum, flushCache, useCache, resultOrder, 
