...
public class ParameterMappingTokenHandler extends BaseBuilder implements TokenHandler{
	...
	private static final String PARAMETER_PROPERTIES = "javaType,jdbcType,mode,numricScale,resultMap,typeHandler,jdbcTypeName";
	...
	public ParameterMappingTokenHandler(List<ParameterMapping> parameterMappings, Configuration configuration,
		Class<?> parameterType, Map<String, Object> addtionalParameters, ParamNameResolver paramNameResolver) {
		super(configuration);
		this.parameterType = parameterType;
		this.metaParameters = configuration.newMetaObject(addtionalParameters);
