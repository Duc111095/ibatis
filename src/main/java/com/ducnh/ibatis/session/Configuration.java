...
import com.ducnh.ibatis.executor.loader.javassist.JavassistProxyFactory;
...
import com.ducnh.ibatis.executor.statement.RoutingStatementHandler;
import com.ducnh.ibatis.executor.statement.StatementHandler;
import com.ducnh.ibatis.binding.MapperRegistry;
import com.ducnh.ibatis.builder.CacheRefResolver;
import com.ducnh.ibatis.builder.IncompleteElementException;
import com.ducnh.ibatis.builder.ResultMapResolver;
import com.ducnh.ibatis.builder.annotation.MethodResolver;
import com.ducnh.ibatis.builder.xml.XMLStatementBuilder;
import com.ducnh.ibatis.cache.Cache;
import com.ducnh.ibatis.cache.decorators.FifoCache;
import com.ducnh.ibatis.cache.decorators.LruCache;
import com.ducnh.ibatis.cache.decorators.SoftCache;
import com.ducnh.ibatis.cache.decorators.WeakCache;
import com.ducnh.ibatis.cache.impl.PerpetualCache;
import com.ducnh.ibatis.datasource.jndi.JndiDataSourceFactory;
import com.ducnh.ibatis.datasource.pooled.PooledDataSourceFactory;
import com.ducnh.ibatis.datasource.unpooled.UnpooledDataSourceFactory;
import com.ducnh.ibatis.executor.BatchExecutor;
import com.ducnh.ibatis.executor.CachingExecutor;
import com.ducnh.ibatis.executor.Executor;
import com.ducnh.ibatis.executor.ReuseExecutor;
import com.ducnh.ibatis.executor.SimpleExecutor;
import com.ducnh.ibatis.executor.keygen.KeyGenerator;
import com.ducnh.ibatis.executor.loader.ProxyFactory;

import com.ducnh.ibatis.io.VFS;
import com.ducnh.ibatis.logging.Log;
import com.ducnh.ibatis.logging.LogFactory;
import com.ducnh.ibatis.logging.commons.JakartaCommonsLoggingImpl;
import com.ducnh.ibatis.logging.jdk14.Jdk14LoggingImpl;
import com.ducnh.ibatis.logging.log4j.Log4jImpl;
import com.ducnh.ibatis.logging.log4j2.Log4j2Impl;
import com.ducnh.ibatis.logging.nologging.NoLoggingImpl;
import com.ducnh.ibatis.logging.slf4j.Slf4jImpl;
import com.ducnh.ibatis.logging.stdout.StdOutImpl;
...
import com.ducnh.ibatis.mapping.VendorDatabaseIdProvider;
import com.ducnh.ibatis.parsing.XNode;
import com.ducnh.ibatis.plugin.Interceptor;
import com.ducnh.ibatis.plugin.InterceptorChain;
...
import com.ducnh.ibatis.reflection.DefaultReflectorFactory;
...
public class Configuration {
	...
	private final ReentrantLock incompleteStatementLock = new ReentrantLock();
	...
	public void setAutoMappingUnknownColumnBehavior(AutoMappingUnknownColumnBehavior autoMapping) {
		this.autoMappingUnknownColumnBehavior = autoMapping;
	}
	...
	public void addIncompleteStatement(XMLStatementBuilder incompleteStatement) {
		incompleteStatementLock.lock();
		try {
			incompleteStatements.add(incompleteStatement);
		} finally {
			incompleteStatementLock.unlock();
		}
	}
